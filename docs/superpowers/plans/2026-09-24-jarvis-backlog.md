...
| 编号 | 问题 | 推荐默认 | 状态 |
|---|---|---|---|
| D1 | 托管会话的轮末播报由谁说？（voice-mini 已经会总结每个会话的结果） | 有贾维斯任务的托管会话由贾维斯说，voice-mini 让出（J5）；其他会话照旧由 voice-mini 说 | ✅ 用户已拍板，按推荐（2026-09-24）；已被 D8 修订 |
...
- 2026-09-24 16:50：维护人直接修复与新功能（均已合入两仓库 `main`；16:39 重启的 DSH 已含前三项，播报模式需再重启一次）：
